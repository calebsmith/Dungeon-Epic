...
class Idevice{
    ...
    public:
        ...
        void put_click(){mouse.click = 1;}
        void put_rclick(){mouse.rclick = 1;}
...
class Viewpoint{
    ...
    public:
        ...
        void put_coor(int xin, int yin){put_x(xin); put_y(yin);}
...
class Location{
    public:
        ...
        void add_flags(int flagsin){flags+=flagsin;}
...
//for entering a map
class Entrance: public virtual Location{
    private:
        int roomid;
    public:
        Entrance(){
...
//for leaving a map
class Leave: public virtual Location{
    private:
        int roomid;
        int destmap;
    public:
        ...
        int get_roomid(){int a; a = roomid; return a;}
        int get_destid(){int a; a = destmap; return a;}
        int get_destmap(){int a = get_destid(); return a;}
};
